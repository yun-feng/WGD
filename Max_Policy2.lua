...
Chrom_Net:add(nn.SpatialConvolution(nkernels[4]/2, 2, 4, 1, 1, 1, 0,0))
Chrom_Net:add(nn.SplitTable(2))
p1=nn.ParallelTable()
p1:add(nn.Reshape(44))
p1:add(nn.Sequential():add(nn.Sum(2)):add(nn.Replicate(44,2)):add(nn.Reshape(44)))
Chrom_Net:add(p1)
