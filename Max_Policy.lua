...
Chrom_Net:add(nn.SpatialConvolution(nfeats/2, nkernels[1], 1, 7, 1, 1, 0,3))
...
Chrom_Net:add(nn.Reshape(nkernels[4]*nchannel))
Chrom_Net:add(nn.Linear(nkernels[4]*nchannel, nkernels[5]))
Chrom_Net:add(nn.Threshold(0, 1e-6))
