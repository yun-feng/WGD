...
Chrom_Net:add(nn.SpatialConvolution(nfeats/2, nkernels[1]/2, 1, 7, 1, 1, 0,3))
Chrom_Net:add(nn.Threshold(0, 1e-6))
Chrom_Net:add(nn.SpatialMaxPooling(1,3,1,3,0,1))
--Chrom_Net:add(nn.Dropout(0.2))

Chrom_Net:add(nn.SpatialConvolution(nkernels[1]/2, nkernels[2]/2, 1, 8, 1, 1, 0,3))
Chrom_Net:add(nn.Threshold(0, 1e-6))
Chrom_Net:add(nn.SpatialMaxPooling(1,2,1,2,0,1))
--Chrom_Net:add(nn.Dropout(0.2))

Chrom_Net:add(nn.SpatialConvolution(nkernels[2]/2, nkernels[3]/2, 1, 8, 1, 1, 0,3))
Chrom_Net:add(nn.Threshold(0, 1e-6))
---Chrom_Net:add(nn.Dropout(0.5))
Chrom_Net:add(nn.SpatialMaxPooling(1,2,1,2,0,1))

Chrom_Net:add(nn.SpatialConvolution(nkernels[3]/2, nkernels[4]/2, 1, 8, 1, 1, 0,3))
Chrom_Net:add(nn.Threshold(0, 1e-6))
